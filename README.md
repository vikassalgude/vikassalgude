<h1 align="center">Hi there, I'm Vikas Salgude 👋</h1>
...
- 🎓 Computer Engineering student at **Trinity Academy of Engineering**, Pune (Expected Graduation: July 2027).
- 💻 Building scalable web applications, real-time communication infrastructure, and developer tools.
- 🧠 Passionate about **Data Structures & Algorithms**, having solved 500+ problems across various platforms.
- 🏆 **Key Achievements:** 1st Prize in Departmental Coding Competition | HackerRank Gold Badges in C++ & Python.
- ⚡ **Fun fact:** When I'm not coding, I'm likely exploring cloud infrastructure or analyzing algorithmic complexities.
...
<p align="center">
  ...
  <a href="https://leetcode.com/vikas_salgude/">
    <img src="https://img.shields.io/badge/LeetCode-Max%20Rating:%201740-FFA116?style=for-the-badge&logo=leetcode&logoColor=black" alt="LeetCode" />
  </a>
</p>
...
*   **InterviewX**: Architected a secure, isolated code execution engine (Piston API) and real-time communication infrastructure (Stream API) for technical interviews.
*   **Secure Media UMS**: Built a robust Node.js backend featuring JWT-based authentication, role-based authorization, and automated cloud storage optimization.
*   **Terraquest**: Developed a full-stack accommodation listing platform with secure session management, CRUD operations, and interactive maps.

*(Detailed repositories available below in my pinned projects)*
